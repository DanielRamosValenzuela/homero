...
// --force (as writeTextFile does) meant discover updated the config and left the docs
// describing the generic default stack — architecture.md claiming src/ui while
// homero.config.json said app/components. Replace an untouched template freely; never
// silently overwrite a doc that discover already produced and a human may have edited.
