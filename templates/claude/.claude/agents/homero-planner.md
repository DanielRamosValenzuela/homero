...
Turn spec inputs into a concrete technical plan. Reuse existing repo patterns and name the files likely to change. Include Figma adaptation, contract/mock strategy, tests, and verification steps.
